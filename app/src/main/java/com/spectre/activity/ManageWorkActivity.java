...
public class ManageWorkActivity extends AppCompatActivity {
    ...
    private String TAG = ManageWorkActivity.class.getName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       // setContentView(R.layout.activity_manage_work);
        context = this;
        Utility.setContentView(context, R.layout.activity_manage_work);
        //  Utility.setUpToolbarWithColor(context, "<font color='#ffffff'>Change Password</font>", true);
        Utility.setUpToolbar_(context, "<font color='#ffffff'>"+getString(R.string.manage_work)+"</font>", true);
        initView();
    }
