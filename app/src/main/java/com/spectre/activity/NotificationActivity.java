...
import com.spectre.adapter.NotificationListAdapter;
...
public class NotificationActivity extends AppCompatActivity {
    ...
    ArrayList<NotificationListUser> Arraylist = new ArrayList<>();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        context = this;
        Utility.setContentView(context, R.layout.activity_notification);
        //  Utility.setUpToolbarWithColor(context, "<font color='#ffffff'>Change Password</font>", true);
        Utility.setUpToolbar_(context, "<font color='#ffffff'>Notifications</font>", true);
        initView();
    }
    ...
    private void setUpRecycler() {
        ...
        mAdapter = new NotificationListAdapter(context, Arraylist, 0);
    ...
    private void saveAndForward(JSONObject js, int i) {
        try {
            ...
            if (jsonArray.length() > 0) {
                ...
                Type type = new TypeToken<List<NotificationListUser>>() {
                }.getType();
                List<NotificationListUser> tempListNewsFeeds = new Gson().fromJson(jsonArray.toString(), type);
                if (i == 0) {
