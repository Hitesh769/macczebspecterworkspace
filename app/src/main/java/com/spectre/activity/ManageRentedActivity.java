...
public class ManageRentedActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_manage_rented);
        context = this;
        ...
        Utility.setUpToolbar_(context, "<font color='#ffffff'>"+getString(R.string.manage_rented)+"</font>", true);
        initView();
    }
