...
public class PermissionsUtils {
    ...
    public boolean isPermissionGranted(final Context context, String permission, String text,int status) {
        if (Build.VERSION.SDK_INT >= SDK_INT_MARSHMALLOW) {
            List<String> permissionsNeeded = new ArrayList<String>();
            final List<String> permissionsList = new ArrayList<String>();
                ...
                .setPositiveButton("Allow", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        if (Build.VERSION.SDK_INT >= PermissionsUtils.SDK_INT_MARSHMALLOW) {
                            if (!PermissionsUtils.getInstance(context).isPermissionGranted(context, Manifest.permission.RECEIVE_SMS, "Receive SMS",0)) {
                                return;
                            }
                        }
                    }
    ...
    public boolean isPermissionGranted(final Context context, final android.support.v4.app.Fragment fragment , String permission, String text) {
    ...
    public boolean requiredPermissionsGranted(final Context context,final android.support.v4.app.Fragment fragment) {
        if (Build.VERSION.SDK_INT >= SDK_INT_MARSHMALLOW) {
            List<String> permissionsNeeded = new ArrayList<String>();
            final List<String> permissionsList = new ArrayList<String>();
    ...
    private boolean addPermission(List<String> permissionsList, String permission, android.support.v4.app.Fragment fragment, Context context) {
