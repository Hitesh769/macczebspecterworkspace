 ...
 */
public class CustomRayMaterialTextView extends com.rey.material.widget.TextView {
    private Typeface tf = null;
    private String customFont;

    public CustomRayMaterialTextView(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
        setCustomFontTextView(context, attrs);
    }

    public CustomRayMaterialTextView(Context context, AttributeSet attrs) {
        super(context, attrs);
        setCustomFontTextView(context, attrs);
    }

    public CustomRayMaterialTextView(Context context) {
        super(context);
