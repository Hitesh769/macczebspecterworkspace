...
public class CustomRayMaterialEditText extends com.rey.material.widget.EditText implements TextWatcher {
    ...
    public CustomRayMaterialEditText(Context context) {
        super(context);
    ...
    public CustomRayMaterialEditText(Context context, AttributeSet attrs) {
        super(context, attrs);
        // TODO Auto-generated constructor stub
        // initViews();
    ...
    public CustomRayMaterialEditText(Context context, AttributeSet attrs, int defStyle) {
